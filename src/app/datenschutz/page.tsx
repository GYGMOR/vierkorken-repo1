      ...
      <div className="section-padding bg-warmwhite">
        <div className="container-custom max-w-4xl px-4 md:px-6">
          ...
          <div className="prose prose-sm md:prose-lg max-w-none space-y-6 text-graphite">
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">1. Allgemeines</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">2. Verantwortlicher</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">4. Zweck der Datenverarbeitung</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">5. Cookies</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">6. Weitergabe von Daten</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">7. Ihre Rechte</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">8. Datensicherheit</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">9. Änderungen</h2>
              <p>
