...
function TabButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`px-4 md:px-6 py-2 md:py-3 rounded-lg font-medium text-xs md:text-sm transition-colors whitespace-nowrap ${
        active
...
function ShareSection() {
  ...
  const shareOnWhatsApp = () => {
    const text = `Entdecke VIERKORKEN - Exklusive Weine und Events! ${shareUrl}?ref=${referralCode}`;
  ...
  return (
    <div className="border-t border-taupe-light pt-6">
      ...
      <p className="text-xs text-graphite/70 mb-4">
        Teilen Sie VIERKORKEN und erhalten Sie 250 Loyalty Punkte, sobald sich jemand über Ihren Link registriert!
      </p>
