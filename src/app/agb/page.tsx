      ...
      <div className="section-padding bg-warmwhite">
        <div className="container-custom max-w-4xl px-4 md:px-6">
          ...
          <div className="prose prose-sm md:prose-lg max-w-none space-y-6 text-graphite">
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">2. Vertragspartner</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">4. Preise und Zahlungsbedingungen</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">5. Lieferung und Versand</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">6. Altersbeschränkung</h2>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">7. Widerrufsrecht</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">8. Gewährleistung</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">9. Haftung</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">10. Loyalty Club</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">11. Anwendbares Recht</h2>
              <p>
