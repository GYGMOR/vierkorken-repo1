        ...
        <div className="container-custom max-w-4xl px-4 md:px-6">
          ...
          <div className="prose prose-sm md:prose-lg max-w-none space-y-6 text-graphite">
            <section>
              ...
              <p>
                Diese Allgemeinen Geschäftsbedingungen (nachfolgend "AGB") gelten für alle Verträge zwischen der VIER KORKEN (nachfolgend "Anbieter") und dem Kunden (nachfolgend "Kunde"), die über den Online-Shop unter vierkorken.ch geschlossen werden.
              </p>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl md:text-2xl lg:text-h3 font-serif text-graphite-dark mb-3 md:mb-4">9. VIER KORKEN Loyalty Club</h2>
              <p>
                <strong>9.1 Teilnahme</strong><br />
                Die Teilnahme am VIER KORKEN Loyalty Club ist kostenlos und freiwillig. Sie erfordert die Registrierung eines Kundenkontos.
              </p>
              <p className="mt-2">
