          ...
          <div className="prose prose-sm md:prose-lg max-w-none space-y-6 text-graphite">
            ...
            <section>
              ...
              <div className="bg-warmwhite-light p-4 md:p-6 rounded-lg mt-3 border border-taupe-light">
                ...
                <p className="mt-2">VIER KORKEN</p>
                <p>Steinbrunnengasse 3A</p>
                <p>5707 Seengen</p>
                <p>Schweiz</p>
              </div>
            ...
            <section>
              ...
              <div className="bg-accent-burgundy/10 p-4 md:p-6 rounded-lg">
                ...
                <ul className="list-disc pl-4 md:pl-6 space-y-2 mt-2">
                  ...
                  <li>
                    versiegelte Waren, die aus Gründen des Gesundheitsschutzes oder der Hygiene
            ...
            <section>
              ...
              <div className="bg-warmwhite-light p-4 md:p-6 rounded-lg border border-taupe-light">
                ...
                <div className="space-y-3 font-mono text-xs md:text-sm">
                  <p>An:</p>
                  <p className="pl-4">VIER KORKEN</p>
                  ...
                  <p className="mt-4">Hiermit widerrufe(n) ich/wir (*) den von mir/uns (*) abgeschlossenen</p>
                  <p>Vertrag über den Kauf der folgenden Waren (*)/die Erbringung der</p>
                  <p>folgenden Dienstleistung (*)</p>

                  <p className="mt-3">_____________________________________________</p>
