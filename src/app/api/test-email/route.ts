  ...
  try {
    ...
    try {
      const result = await sendInfoMail({
        to: testEmail,
        subject: '🧪 VIER KORKEN Test-E-Mail via Resend.com',
        html: `
          <!DOCTYPE html>
          <html>
