  ...
  return (
    <article className="card group hover:shadow-strong transition-all duration-300 border-2 border-taupe-light relative">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* Read More Link / Reserve & Share */}
        <div className="flex items-center justify-between mt-auto">
          {news.type === "EVENT" ? (
            <Link
              href={`/news/${news.slug}`}
              className="inline-flex items-center gap-2 bg-accent-burgundy text-white px-4 py-2 rounded-md font-medium hover:bg-wine-dark hover:gap-3 transition-all shadow-sm"
            >
              Jetzt reservieren
