    ...
    <footer className={cn('bg-graphite-darker text-warmwhite section-padding', className)}>
      <div className="container-custom">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div>
            <h3 className="font-serif text-xl mb-4 text-accent-gold">VIERKORKEN</h3>
            ...
            <div className="mt-4">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2701.234!2d8.19167!3d47.31944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDfCsDE5JzEwLjAiTiA4wrAxMSczMC4wIkU!5e0!3m2!1sde!2sch!4v1234567890!5m2!1sde!2sch&q=Vier+Korken+Wein-Boutique,+Steinbrunnengasse+3A,+5707+Seengen"
                width="100%"
                height="150"
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-warmwhite/60">
          <p>&copy; {currentYear} VIERKORKEN. Alle Rechte vorbehalten.</p>
