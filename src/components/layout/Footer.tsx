    ...
    <footer className={cn('bg-graphite-darker text-warmwhite section-padding', className)}>
      <div className="container-custom">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          {/* Brand */}
          <div>
            <h3 className="font-serif text-xl mb-4 text-accent-gold">Vier Korken Wein-Boutique</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-warmwhite/70">
              ...
              <li>
                <Link href="/impressum" className="hover:text-warmwhite transition-colors">
                  Impressum
                </Link>
              </li>
              <li>
