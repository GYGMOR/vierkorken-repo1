  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        {
          name: 'Bestellungen',
          href: '/admin/statistiken/bestellungen',
        },
        {
          name: 'Webseite',
          href: '/admin/statistiken/webseite',
        },
      ],
    },
    {
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 bg-accent-burgundy">
          ...
          <button
            ...
            className="lg:hidden text-warmwhite hover:text-warmwhite/80"
          >
        ...
        <div className="px-6 py-4 border-b border-graphite">
          <p className="text-xs uppercase tracking-wider text-taupe">Admin Panel</p>
        </div>
        ...
        <div className="p-4 border-t border-graphite">
          <button
            ...
            className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm font-medium text-taupe hover:bg-graphite hover:text-warmwhite transition-colors"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm font-medium text-taupe hover:bg-graphite hover:text-warmwhite transition-colors mt-2"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
            </svg>
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-40 flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200">
          <button
            ...
            className="lg:hidden text-graphite hover:text-graphite-dark"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
