...
export const CategoryIcons: Record<string, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    glass: (props) => (
        <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 21v-8m0 0V5a2 2 0 10-4 0v8a4 4 0 104 0h0a4 4 0 104 0V5a2 2 0 10-4 0v8z" />
        </svg>
    ),
    barrel: (props) => (
        <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 6h16M4 10h16M4 14h16M4 18h16M7.5 2h9M7.5 22h9M4 6a4 4 0 010 12m16-12a4 4 0 000 12" />
        </svg>
    ),
    map: (props) => (
        <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
